...
//	public static final Effect SCALD_II = new EffectScald("scald_high", EffectType.HARMFUL, 0xE55010);
	...
	public static final Effect BREAK_SHELD = new EffectBase("break_sheld", EffectType.HARMFUL, 0x125C89).addAttributesModifier(SharedMonsterAttributes.ARMOR, "7197DE5E-7CF8-4030-949E-514C1F120350", (double)-4F, AttributeModifier.Operation.ADDITION);
	public static final Effect TEMP_STRENGTH = new EffectBase("temp_strength", EffectType.BENEFICIAL, 0x125C89);
