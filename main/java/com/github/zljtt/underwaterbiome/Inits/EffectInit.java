...
public class EffectInit 
{
	...
	public static final Effect FROST_BITE = new EffectBase("frost_bite", EffectType.HARMFUL, 0x53A1FC);
	public static final Effect SCALD = new EffectBase("scald", EffectType.HARMFUL, 0xE55010);
