...
{
	public BiomeMangrove(float depth, float scale,int color, String parent,int weight,Difficulty pollution) 
	{
	      ...
	      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(FeatureInit.MANGROVE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.COUNT_TOP_SOLID, new FrequencyConfig(3)));
...
//	      this.addCarver(GenerationStage.Carving.LIQUID, Biome.createCarver(WorldCarver.UNDERWATER_CAVE, new ProbabilityConfig(0.03F)));
	...
	{
	    return new TranslationTextComponent(I18n.format("biome.underwaterbiome.mangrave_forest"));
	}
