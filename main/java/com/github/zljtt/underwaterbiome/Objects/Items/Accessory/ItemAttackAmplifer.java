...
public class ItemAttackAmplifer extends ItemAccessoryBase
{

	public ItemAttackAmplifer(String name, Properties property, ObtainType ob, boolean needBlueprint, BlueprintType type,
			int... difficulty) 
	{
	...
	public <T extends Event> T editEffect(World worldIn, PlayerEntity player, T target) 
	{
		...
		{
			if(player.isPotionActive(EffectInit.TEMP_STRENGTH))
			{
