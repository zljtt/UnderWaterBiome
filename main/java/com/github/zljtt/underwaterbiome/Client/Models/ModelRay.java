...
public class ModelRay extends EntityModel<EntityRay> 
{
	...
	@Override
	public void render(EntityRay entity, float f, float f1, float f2, float f3, float f4, float f5) {
		bone.render(f5);
	}
	...
	@Override
	public void setRotationAngles(EntityRay entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
	{
