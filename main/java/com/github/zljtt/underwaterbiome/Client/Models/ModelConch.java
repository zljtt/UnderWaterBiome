...
@OnlyIn(Dist.CLIENT)
public class ModelConch extends EntityModel<EntityConch> 
{
	...
	@Override
	public void render(EntityConch entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
