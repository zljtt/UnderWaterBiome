...
public class UnderWaterBiome
{
    ...
    public static final WorldType OCEAN_TYPE = new WorldTypeOcean();
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("underwaterbiome", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
